                    ...
                    <div class="bet-component">
                        <div class="bet-form">
							...
							<div class="button-group__wrap">
								...
								<span class="button-group-label"><span>Количество бомб</span></span>
							</div>
                            <button type="button" class="btn btn-green btn-play"><span>Играть</span></button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/tower.blade.php ENDPATH**/ ?>