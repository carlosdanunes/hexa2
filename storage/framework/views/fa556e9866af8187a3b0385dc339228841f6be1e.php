                ...
                <div class="sidebar-block">
                    <div class="bet-component">
                        <div class="bet-form">
                            ...
                            <button type="button" class="btn btn-green btn-play"><span>Создать игру</span></button>
                        </div>
				...
				<div class="game-block">
					<div class="progress-wrap">
						<div class="progress-item left">
							<div class="title">Мин. сумма: <span id="minBet"><?php echo e($settings->flip_min_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
							<div class="title">Макс. сумма: <span id="maxBet"><?php echo e($settings->flip_max_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
						</div>
					</div>
                                            ...
                                            <div class="game-coin flip_<?php echo e($rl['id']); ?>">
                                                    ...
                                                    <div class="right">
                                                        <div class="players block">
                                                            <div class="user">
                                                                ...
                                                                <div class="info">
                                                                    <div class="name">Ожидаем оппонента</div>
                                                ...
                                                <div class="bottom">
													<div class="info block">
														<div class="bank">
															<span class="type">Банк игры:</span>
														...
														<div class="ticket">
															<span class="type">Счастливый билет:</span>
                                            ...
                                            <div class="game-coin flip_<?php echo e($rl['id']); ?>">
                                                <div class="top">
                                                    ...
                                                    <div class="right">
                                                        <div class="players block">
                                                            <div class="user">
                                                                <button type="button" class="btn btn-primary btn-join" data-id="<?php echo e($rl['id']); ?>"><span>Вступить</span></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
			...
			<div class="table-heading">
				<div class="thead">
					<div class="tr">
						...
						<div class="th">Банк</div>
						<div class="th">Счастливый билет</div>
						<div class="th">Проверка</div>
					</div>
				</div>
			</div>
					...
					<table class="table">
						<tbody>
							...
							<tr>
								...
								<td>
									<button class="btn btn-primary checkGame" data-hash="<?php echo e($end->hash); ?>">Проверить</button>
								</td>
							</tr>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</tbody>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/coinflip.blade.php ENDPATH**/ ?>