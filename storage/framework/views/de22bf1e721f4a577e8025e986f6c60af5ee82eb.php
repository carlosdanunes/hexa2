                ...
                <div class="sidebar-block">
                    <div class="bet-component">
                        <div class="bet-form">
                            ...
                            <button type="button" class="btn btn-green btn-play" style="<?php if(!is_null($bet)): ?> display : none; <?php endif; ?>"><span>Сделать ставку</span></button>
                            <button type="button" class="btn btn-green btn-withdraw" style="<?php if(is_null($bet)): ?> display : none; <?php endif; ?>"><span>Вывести</span></button>
                        </div>
				...
				<div class="game-block">
					<div class="progress-wrap">
						<div class="progress-item left">
							<div class="title">Мин. сумма: <span id="minBet"><?php echo e($settings->crash_min_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
							<div class="title">Макс. сумма: <span id="maxBet"><?php echo e($settings->crash_max_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
						</div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/crash.blade.php ENDPATH**/ ?>