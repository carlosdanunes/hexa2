$(document).ready(function() {
	...
	socket.on('hilo.newBet', function(data) {
        ...
        data.bets.forEach(function (bet) {			
			html += '<tr><td class="username"><button type="button" class="btn btn-link" data-id="'+ bet.unique_id +'"><span class="sanitize-user"><div class="sanitize-avatar"><img src="'+ bet.avatar +'" alt=""></div><span class="sanitize-name">'+ bet.username +'</span></span></button></td><td><div class="bet-number"><span class="bet-wrap"><span>'+ bet.sum +'</span><svg class="icon icon-coin '+ bet.balance +'"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></span></div></td><td>'+ bet.type +'</td><td>'+ bet.multipler +'x</td><td><div class="bet-number"><span class="bet-wrap win"><span>'+ bet.win +'</span><svg class="icon icon-coin '+ bet.balance +'"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></span></div></td></tr>';
        });
