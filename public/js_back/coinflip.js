	...
	socket.on('new.flip', function (data) {
		if(USER_ID == data.unique_id) {
			var you = '';
				...
				you += '<div class="bank">';
				you += '<span class="type">Банк игры:</span>';
				...
				you += '<span class="type">Счастливый билет:</span>';
		...
		var all = '';
			...
			all += '<div class="players block">';
			all += '<div class="user">';
			all += '<button type="button" class="btn btn-primary btn-join" data-id="'+ data.id +'"><span>Вступить</span></button>';
			all += '</div>';
			all += '</div>';
			all += '</div>';
			all += '</div>';
			...
			all += '<div class="bank">';
			all += '<span class="type">Банк игры:</span>';
			...
			all += '<span class="type">Счастливый билет:</span>';
