...
$(document).ready(function() {
	...
	.on('ban_message', function(data) {
		if(data.ban) {
			...
			$('.message-block.user_' + data.unique_id + ' .delete').append('<button type="button" class="btn btn-light btnBan" data-name="' + data.username + '" data-id="' + data.unique_id + '"><svg class="icon"><use xlink:href="/img/symbols.svg#icon-ban"></use></svg><span>Забанить</span></button>');
		}
	})
});
